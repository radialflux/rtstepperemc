                            ...
                            setup_pointer settings)     //!< pointer to machine settings                   
{
  ...
  if (settings->motion_mode != motion) {
    CHKS((block->z_flag == OFF),
        _readers[(int)'z']? NCE_Z_VALUE_UNSPECIFIED_IN_XY_PLANE_CANNED_CYCLE: EMC_I18N("G17 canned cycle is not possible on a machine without Z axis"));
  }
  block->z_number =
                            ...
                            setup_pointer settings)     //!< pointer to machine settings                   
{
  ...
  if (settings->motion_mode != motion) {
    CHKS((block->w_flag == OFF),
        _readers[(int)'w']? NCE_W_VALUE_UNSPECIFIED_IN_UV_PLANE_CANNED_CYCLE: EMC_I18N("G17.1 canned cycle is not possible on a machine without W axis"));
  }
  block->w_number =
                            ...
                            setup_pointer settings)     //!< pointer to machine settings                   
{
  ...
  if (settings->motion_mode != motion) {
    CHKS((block->x_flag == OFF),
        _readers[(int)'x']? NCE_X_VALUE_UNSPECIFIED_IN_YZ_PLANE_CANNED_CYCLE: EMC_I18N("G19 canned cycle is not possible on a machine without X axis"));
  }
  block->x_number =
                            ...
                            setup_pointer settings)     //!< pointer to machine settings                   
{
  ...
  if (settings->motion_mode != motion) {
    CHKS((block->x_flag == OFF),
        _readers[(int)'u']? NCE_U_VALUE_UNSPECIFIED_IN_VW_PLANE_CANNED_CYCLE: EMC_I18N("G19.1 canned cycle is not possible on a machine without U axis"));
  }
  block->u_number =
                            ...
                            setup_pointer settings)     //!< pointer to machine settings                   
{
  ...
  if (settings->motion_mode != motion) {
    CHKS((block->y_flag == OFF),
        _readers[(int)'y']? NCE_Y_VALUE_UNSPECIFIED_IN_XZ_PLANE_CANNED_CYCLE: EMC_I18N("G18 canned cycle is not possible on a machine without Y axis"));
  }
  block->y_number =
                            ...
                            setup_pointer settings)     //!< pointer to machine settings                   
{
  ...
  if (settings->motion_mode != motion) {
    CHKS((block->v_flag == OFF),
        _readers[(int)'v']? NCE_V_VALUE_UNSPECIFIED_IN_UW_PLANE_CANNED_CYCLE: EMC_I18N("G18.1 canned cycle is not possible on a machine without V axis"));
  }
  block->v_number =
