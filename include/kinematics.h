...
/* the forward kinematics take joint values and determine world coordinates,
   ...
   passed in. */
   extern int kinematicsForward(const double *joint, struct EmcPose *world, const KINEMATICS_FORWARD_FLAGS * fflags, KINEMATICS_INVERSE_FLAGS * iflags);
...
/* the inverse kinematics take world coordinates and determine joint values,
   ...
   passed in. */
   extern int kinematicsInverse(const struct EmcPose *world, double *joint, const KINEMATICS_INVERSE_FLAGS * iflags, KINEMATICS_FORWARD_FLAGS * fflags);
...
/* the home kinematics function sets all its arguments to their proper
   ...
   should be used.
*/
   extern int kinematicsHome(struct EmcPose *world, double *joint, KINEMATICS_FORWARD_FLAGS * fflags, KINEMATICS_INVERSE_FLAGS * iflags);
